...
English and Armenian; eight network profiles. Drag letters to complete the configured words, then use the endcard CTA. The runtime owns completion, audio and store dispatch.

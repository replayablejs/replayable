...
Versions `0.1.0-alpha.0` and `0.1.0-alpha.1` have been published. `.changeset/pre.json`
keeps Changesets in alpha mode. After CI passes on main, the release workflow prepares
a version pull request or publishes already-versioned packages through npm trusted publishing.
